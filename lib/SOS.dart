...
class _SosScreenState extends State<SosScreen>
  ...
  Future<void> _sendSOS() async {
    try {
      ...
      // Call the email function with a dynamic recipient email
      await _sendEmail(
          message, '2k23.mca2313246@gmail.com'); // Update email here
  ...
  Future<void> _sendEmail(String message, String recipientEmail) async {
    // Replace with your email and app password
    String username = 'siddhimishra122@gmail.com';
    String password = 'jeoe qjbu muvy zvgn'; // Use App Password for Gmail
